    ...
    <div className="auth-actions">
      ...
      {profileReplacement ? profileReplacement : (
        <Link to="/me" className="nav-icon-link">
          {profilePicture ? (
            <img src={profilePicture} alt="Profile" style={{width:28,height:28,borderRadius:'50%',objectFit:'cover'}} />
          ) : (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="8" r="4"/><path d="M20 20v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/></svg>
          )}
        </Link>
      )}
      <style>{`
