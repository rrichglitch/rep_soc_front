  ...
  return (
    <div className="my-profile-page">
      <TopBar
        ...
        right={<AuthActions profileReplacement={<button onClick={() => { auth.removeUser(); window.location.href = 'https://auth.spacetimedb.com/oidc/session/end?post_logout_redirect_uri=' + window.location.origin; }} className="topbar-signin" style={{background:"#dc2626"}}>Logout</button>} />}
      />
