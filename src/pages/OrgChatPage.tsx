    ...
    <div className="chat-page">
      ...
      <main className="chat-main">
        ...
        <form onSubmit={e => { e.preventDefault(); handleSend(); }} className="msg-form">
          ...
          <button type="submit" className="msg-send"><svg width="20" height="20" viewBox="0 0 20 20" fill="white"><path d="M3.105 2.289a.75.75 0 00-.826.95l1.414 4.925A1.5 1.5 0 005.135 9.25h6.115a.75.75 0 010 1.5H5.135a1.5 1.5 0 00-1.442 1.086l-1.414 4.926a.75.75 0 00.826.95 28.896 28.896 0 0015.293-7.154.75.75 0 000-1.115A28.897 28.897 0 003.105 2.288z"/></svg></button>
        </form>
      </main>
      ...
      <style>{`
        ...
        .msg-input { flex: 1; padding: 12px; border: 1px solid #e0e0e0; border-radius: 24px; outline: none; font-size: 15px; background: white; }
