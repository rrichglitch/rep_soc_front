...
function coerceParams(params4) {
  return Object.fromEntries(
    Object.entries(params4).map(([n, c]) => [
      n,
...
var DbConnectionImpl = class {
  ...
  constructor({
    ...
    const url = new URL(uri2.toString());
    if (!/^wss?:/.test(uri2.protocol)) {
  ...
  #makeReducers(def) {
    ...
    for (const reducer of def.reducers) {
      ...
      out[key] = (params4) => {
        ...
        serializeArgs(writer, params4);
        const argsBuffer = writer.getBuffer();
        return this.callReducer(reducerName, argsBuffer, params4);
      };
    }
    return out;
  }
   ...
   */
  callReducerWithParams(reducerName, _paramsType, params4) {
    const writer = new BinaryWriter(1024);
    this.#reducerArgsSerializers[reducerName].serialize(writer, params4);
    const argsBuffer = writer.getBuffer();
    return this.callReducer(reducerName, argsBuffer, params4);
  }
  /**
   ...
   * @param params The arguments to pass to the reducer
   */
  callProcedureWithParams(procedureName, _paramsType, params4, _returnType) {
    const writer = new BinaryWriter(1024);
    const { serializeArgs, deserializeReturn } = this.#procedureSerializers[procedureName];
    serializeArgs(writer, params4);
    const argsBuffer = writer.getBuffer();
...
function tablesToSchema(ctx, tables2) {
  return {
    tables: Object.fromEntries(
      Object.entries(tables2).map(([accName, schema2]) => [
        accName,
...
function reducerSchema(name, params4) {
  const paramType = {
    elements: Object.entries(params4).map(([n, c]) => ({
      name: n,
...
function procedureSchema(name, params4, returnType4) {
  return {
    name,
    accessorName: toCamelCase(name),
    params: coerceParams(params4),
    returnType: returnType4
  };
}

// src/module_bindings/accept_friend_request_reducer.ts
var accept_friend_request_reducer_default = {
  requestId: t.u64(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/accept_org_member_reducer.ts
var accept_org_member_reducer_default = {
  requestId: t.u64()
};

// src/module_bindings/admin_delete_profile_reducer.ts
var admin_delete_profile_reducer_default = {
  targetIdentity: t.identity(),
  adminSecret: t.string()
};

// src/module_bindings/admin_set_birthday_reducer.ts
var admin_set_birthday_reducer_default = {
  targetIdentity: t.identity(),
  birthday: t.string(),
  adminSecret: t.string()
};

// src/module_bindings/admin_set_pro_reducer.ts
var admin_set_pro_reducer_default = {
  targetIdentity: t.identity(),
  adminSecret: t.string()
};

// src/module_bindings/admin_update_profile_reducer.ts
var admin_update_profile_reducer_default = {
  targetIdentity: t.identity(),
  adminSecret: t.string(),
  email: t.option(t.string()),
  fullName: t.option(t.string()),
  profilePicture: t.option(t.string()),
  city: t.option(t.string()),
  description: t.option(t.string()),
  isPro: t.option(t.bool())
};

// src/module_bindings/cancel_friend_request_reducer.ts
var cancel_friend_request_reducer_default = {
  toIdentity: t.identity(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/claim_profile_reducer.ts
var claim_profile_reducer_default = {
  email: t.string()
};

// src/module_bindings/create_organization_reducer.ts
var create_organization_reducer_default = {
  name: t.string(),
  picture: t.string(),
  city: t.string(),
  description: t.string(),
  locationLat: t.option(t.f64()),
  locationLng: t.option(t.f64())
};

// src/module_bindings/create_profile_reducer.ts
var create_profile_reducer_default = {
  email: t.string(),
  fullName: t.string(),
...
// src/module_bindings/create_story_post_reducer.ts
var create_story_post_reducer_default = {
  profileOwnerIdentity: t.identity(),
  content: t.string(),
  mediaData: t.option(t.string()),
  mediaTypes: t.option(t.string()),
  actingAsOrgId: t.option(t.u64())
};

// src/module_bindings/decline_friend_request_reducer.ts
var decline_friend_request_reducer_default = {
  requestId: t.u64(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/decline_org_member_reducer.ts
var decline_org_member_reducer_default = {
  requestId: t.u64()
};

// src/module_bindings/delete_story_post_reducer.ts
var delete_story_post_reducer_default = {
  postId: t.u64()
};

// src/module_bindings/demote_co_leader_reducer.ts
var demote_co_leader_reducer_default = {
  orgId: t.u64(),
  memberIdentity: t.identity()
};

// src/module_bindings/follow_reducer.ts
var follow_reducer_default = {
  targetIdentity: t.identity(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/jitter_org_to_approx_reducer.ts
var jitter_org_to_approx_reducer_default = {
  orgId: t.u64()
};

// src/module_bindings/jitter_to_approx_reducer.ts
var jitter_to_approx_reducer_default = {};

// src/module_bindings/manual_create_profile_reducer.ts
var manual_create_profile_reducer_default = {
  targetIdentity: t.identity(),
  email: t.string(),
  fullName: t.string(),
  adminSecret: t.string(),
...
// src/module_bindings/promote_to_co_leader_reducer.ts
var promote_to_co_leader_reducer_default = {
  orgId: t.u64(),
  memberIdentity: t.identity()
};

// src/module_bindings/refresh_feed_reducer.ts
var refresh_feed_reducer_default = {};

// src/module_bindings/register_push_subscription_reducer.ts
var register_push_subscription_reducer_default = {
  endpoint: t.string(),
  p256Dh: t.string(),
  auth: t.string()
};

// src/module_bindings/remove_org_member_reducer.ts
var remove_org_member_reducer_default = {
  orgId: t.u64(),
  memberIdentity: t.identity()
};

// src/module_bindings/resolve_notification_reducer.ts
var resolve_notification_reducer_default = {
  notificationId: t.u64()
};

// src/module_bindings/send_direct_message_reducer.ts
var send_direct_message_reducer_default = {
...
// src/module_bindings/send_friend_request_reducer.ts
var send_friend_request_reducer_default = {
  toIdentity: t.identity(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/send_org_member_request_reducer.ts
var send_org_member_request_reducer_default = {
  orgId: t.u64(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/send_org_message_reducer.ts
var send_org_message_reducer_default = {
  orgId: t.u64(),
  content: t.string(),
  actingAsOrgId: t.option(t.u64())
};

// src/module_bindings/transfer_leadership_reducer.ts
var transfer_leadership_reducer_default = {
  orgId: t.u64(),
  newLeaderIdentity: t.identity()
};

// src/module_bindings/unfollow_reducer.ts
var unfollow_reducer_default = {
  targetIdentity: t.identity(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/unfriend_reducer.ts
var unfriend_reducer_default = {
  targetIdentity: t.identity(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgIdentity: t.option(t.identity())
};

// src/module_bindings/unregister_push_subscription_reducer.ts
var unregister_push_subscription_reducer_default = {
  endpoint: t.string()
};

// src/module_bindings/update_feed_scroll_position_reducer.ts
var update_feed_scroll_position_reducer_default = {
  lastReadAt: t.timestamp()
};

// src/module_bindings/update_location_reducer.ts
var update_location_reducer_default = {
  lat: t.f64(),
  lng: t.f64(),
  precision: t.string()
};

// src/module_bindings/update_org_location_reducer.ts
var update_org_location_reducer_default = {
  orgId: t.u64(),
  lat: t.f64(),
  lng: t.f64(),
  precision: t.string()
...
// src/module_bindings/update_organization_reducer.ts
var update_organization_reducer_default = {
  orgId: t.u64(),
  picture: t.option(t.string()),
  city: t.option(t.string()),
  description: t.option(t.string()),
  locationLat: t.option(t.f64()),
  locationLng: t.option(t.f64()),
  hideMembers: t.option(t.bool()),
  gender: t.option(t.string())
};

// src/module_bindings/update_profile_reducer.ts
var update_profile_reducer_default = {
  profilePicture: t.option(t.string()),
  city: t.option(t.string()),
  description: t.option(t.string()),
  hideFriends: t.option(t.bool()),
  gender: t.option(t.string())
};

// src/module_bindings/upgrade_to_pro_reducer.ts
var upgrade_to_pro_reducer_default = {};

// src/module_bindings/types.ts
var CheckDiditResult = t.object("CheckDiditResult", {
  success: t.bool(),
  fullName: t.option(t.string()),
  selfieImage: t.option(t.string()),
  status: t.option(t.string()),
  error: t.option(t.string())
});
var CreateVerifiedProfileResult = t.object("CreateVerifiedProfileResult", {
  success: t.bool(),
  error: t.option(t.string())
});
var FeedPosition = t.object("FeedPosition", {
  identity: t.identity(),
  lastReadAt: t.timestamp(),
  lastFeedLoadAt: t.timestamp(),
  createdAt: t.timestamp(),
  updatedAt: t.timestamp()
});
var FeedStory = t.object("FeedStory", {
  id: t.u64(),
  profileOwnerIdentity: t.identity(),
  posterIdentity: t.identity(),
  content: t.string(),
  mediaData: t.string(),
  mediaTypes: t.string(),
  createdAt: t.timestamp(),
  posterName: t.string(),
  posterPicture: t.string(),
  profileOwnerName: t.string(),
  profileOwnerPicture: t.string(),
  actingAsOrgId: t.option(t.u64()),
  actingAsOrgName: t.option(t.string()),
  actingAsOrgPicture: t.option(t.string())
});
var Following = t.object("Following", {
  followerIdentity: t.identity(),
  followingIdentity: t.identity(),
  createdAt: t.timestamp()
});
var FriendRequest = t.object("FriendRequest", {
  id: t.u64(),
...
var Friendship = t.object("Friendship", {
  id: t.u64(),
  userA: t.identity(),
  userB: t.identity(),
  createdAt: t.timestamp()
});
var InitiateDiditResult = t.object("InitiateDiditResult", {
  success: t.bool(),
  url: t.option(t.string()),
  error: t.option(t.string())
});
var LastPost = t.object("LastPost", {
  posterIdentity: t.identity(),
  profileOwnerIdentity: t.identity(),
  lastPostedAt: t.timestamp()
});
var Message = t.object("Message", {
  id: t.u64(),
  senderIdentity: t.identity(),
  recipientIdentity: t.option(t.identity()),
  orgId: t.option(t.u64()),
  content: t.string(),
  createdAt: t.timestamp()
});
var MonthlyVerificationCap = t.object("MonthlyVerificationCap", {
  monthKey: t.string(),
  completedCount: t.u32(),
  updatedAt: t.timestamp()
});
var MyFeed = t.object("MyFeed", {});
var Notification = t.object("Notification", {
  id: t.u64(),
  recipientIdentity: t.identity(),
  type: t.string(),
  fromIdentity: t.option(t.identity()),
  orgId: t.option(t.u64()),
  message: t.string(),
  createdAt: t.timestamp(),
  resolved: t.bool(),
  referenceId: t.option(t.u64())
});
var OrgMemberRequest = t.object("OrgMemberRequest", {
  id: t.u64(),
  orgId: t.u64(),
  fromIdentity: t.identity(),
  status: t.string(),
...
var Organization = t.object("Organization", {
  id: t.u64(),
  name: t.string(),
  picture: t.string(),
  city: t.string(),
  ...
  locationLat: t.option(t.f64()),
  locationLng: t.option(t.f64()),
  locationPrecision: t.string(),
  hideMembers: t.bool(),
  birthday: t.option(t.string()),
  gender: t.option(t.string())
});
var OrganizationMember = t.object("OrganizationMember", {
  orgId: t.u64(),
  memberIdentity: t.identity(),
  role: t.string(),
  joinedAt: t.timestamp()
});
var PendingRegistration = t.object("PendingRegistration", {
  identity: t.identity(),
  email: t.string(),
  fullName: t.string(),
  legalName: t.string(),
  ...
  diditSessionId: t.string(),
  createdAt: t.timestamp(),
  profilePicture: t.string(),
  diditSelfieImage: t.string()
});
var PushSubscription = t.object("PushSubscription", {
  identity: t.identity(),
  endpoint: t.string(),
  p256Dh: t.string(),
  auth: t.string(),
...
var StoryPost = t.object("StoryPost", {
  id: t.u64(),
  profileOwnerIdentity: t.identity(),
  posterIdentity: t.identity(),
  content: t.string(),
...
var UserBirthday = t.object("UserBirthday", {
  identity: t.identity(),
  birthday: t.string()
});
var UserProfile = t.object("UserProfile", {
  identity: t.identity(),
  email: t.string(),
  fullName: t.string(),
  city: t.string(),
  ...
  createdAt: t.timestamp(),
  phoneNumber: t.string(),
  phoneVerified: t.bool(),
  profilePicture: t.string(),
  isPro: t.bool(),
  manuallyCreated: t.bool(),
  locationLat: t.option(t.f64()),
  locationLng: t.option(t.f64()),
  locationPrecision: t.string(),
  locationAsked: t.bool(),
  hideFriends: t.bool(),
  birthday: t.option(t.string()),
  gender: t.option(t.string()),
  age: t.option(t.u8())
});
var VerificationRateLimit = t.object("VerificationRateLimit", {
  identity: t.identity(),
  attemptCount: t.u32(),
  lastAttemptAt: t.timestamp(),
  firstAttemptAt: t.timestamp()
});
var VerifiedIdentity = t.object("VerifiedIdentity", {
  identity: t.identity(),
  legalName: t.string(),
  diditVerified: t.bool(),
  diditSelfieImage: t.string()
});

// src/module_bindings/check_didit_verification_procedure.ts
var params = {
  sessionId: t.string()
};
var returnType = CheckDiditResult;

// src/module_bindings/create_verified_profile_procedure.ts
var params2 = {
  sessionId: t.string(),
  profilePicture: t.string(),
  city: t.string(),
...
var returnType2 = CreateVerifiedProfileResult;

// src/module_bindings/initiate_didit_verification_procedure.ts
var params3 = {
  email: t.string(),
  profilePicture: t.string(),
  city: t.string(),
...
var returnType3 = InitiateDiditResult;

// src/module_bindings/following_table.ts
var following_table_default = t.row({
  followerIdentity: t.identity().name("follower_identity"),
  followingIdentity: t.identity().name("following_identity"),
  createdAt: t.timestamp().name("created_at")
});

// src/module_bindings/friend_request_table.ts
var friend_request_table_default = t.row({
  id: t.u64().primaryKey(),
  fromIdentity: t.identity().name("from_identity"),
  toIdentity: t.identity().name("to_identity"),
  status: t.string(),
  createdAt: t.timestamp().name("created_at")
});

// src/module_bindings/friendship_table.ts
var friendship_table_default = t.row({
  id: t.u64().primaryKey(),
  userA: t.identity().name("user_a"),
  userB: t.identity().name("user_b"),
  createdAt: t.timestamp().name("created_at")
});

// src/module_bindings/message_table.ts
var message_table_default = t.row({
  id: t.u64().primaryKey(),
  senderIdentity: t.identity().name("sender_identity"),
  recipientIdentity: t.option(t.identity()).name("recipient_identity"),
  orgId: t.option(t.u64()).name("org_id"),
  content: t.string(),
  createdAt: t.timestamp().name("created_at")
});

// src/module_bindings/my_feed_table.ts
var my_feed_table_default = t.row({
  id: t.u64(),
  profileOwnerIdentity: t.identity().name("profile_owner_identity"),
  posterIdentity: t.identity().name("poster_identity"),
  content: t.string(),
  mediaData: t.string().name("media_data"),
  mediaTypes: t.string().name("media_types"),
  createdAt: t.timestamp().name("created_at"),
  posterName: t.string().name("poster_name"),
  posterPicture: t.string().name("poster_picture"),
  profileOwnerName: t.string().name("profile_owner_name"),
  profileOwnerPicture: t.string().name("profile_owner_picture"),
  actingAsOrgId: t.option(t.u64()).name("acting_as_org_id"),
  actingAsOrgName: t.option(t.string()).name("acting_as_org_name"),
  actingAsOrgPicture: t.option(t.string()).name("acting_as_org_picture")
});

// src/module_bindings/notification_table.ts
var notification_table_default = t.row({
  id: t.u64().primaryKey(),
  recipientIdentity: t.identity().name("recipient_identity"),
  type: t.string(),
  fromIdentity: t.option(t.identity()).name("from_identity"),
  orgId: t.option(t.u64()).name("org_id"),
  message: t.string(),
  createdAt: t.timestamp().name("created_at"),
  resolved: t.bool(),
  referenceId: t.option(t.u64()).name("reference_id")
});

// src/module_bindings/org_member_request_table.ts
var org_member_request_table_default = t.row({
  id: t.u64().primaryKey(),
  orgId: t.u64().name("org_id"),
  fromIdentity: t.identity().name("from_identity"),
  status: t.string(),
  createdAt: t.timestamp().name("created_at")
});

// src/module_bindings/organization_table.ts
var organization_table_default = t.row({
  id: t.u64().primaryKey(),
  name: t.string(),
  picture: t.string(),
  city: t.string(),
  description: t.string(),
  leaderIdentity: t.identity().name("leader_identity"),
  createdAt: t.timestamp().name("created_at"),
  isPro: t.bool().name("is_pro"),
  locationLat: t.option(t.f64()).name("location_lat"),
  locationLng: t.option(t.f64()).name("location_lng"),
  locationPrecision: t.string().name("location_precision"),
  hideMembers: t.bool().name("hide_members"),
  birthday: t.option(t.string()),
  gender: t.option(t.string())
});

// src/module_bindings/organization_member_table.ts
var organization_member_table_default = t.row({
  orgId: t.u64().name("org_id"),
  memberIdentity: t.identity().name("member_identity"),
  role: t.string(),
  joinedAt: t.timestamp().name("joined_at")
});

// src/module_bindings/story_post_table.ts
var story_post_table_default = t.row({
  id: t.u64().primaryKey(),
  profileOwnerIdentity: t.identity().name("profile_owner_identity"),
  posterIdentity: t.identity().name("poster_identity"),
  content: t.string(),
...
// src/module_bindings/user_profile_table.ts
var user_profile_table_default = t.row({
  identity: t.identity().primaryKey(),
  email: t.string(),
  fullName: t.string().name("full_name"),
  city: t.string(),
  description: t.string(),
  createdAt: t.timestamp().name("created_at"),
  phoneNumber: t.string().name("phone_number"),
  phoneVerified: t.bool().name("phone_verified"),
  profilePicture: t.string().name("profile_picture"),
  isPro: t.bool().name("is_pro"),
  manuallyCreated: t.bool().name("manually_created"),
  locationLat: t.option(t.f64()).name("location_lat"),
  locationLng: t.option(t.f64()).name("location_lng"),
  locationPrecision: t.string().name("location_precision"),
  locationAsked: t.bool().name("location_asked"),
  hideFriends: t.bool().name("hide_friends"),
  birthday: t.option(t.string()),
  gender: t.option(t.string()),
  age: t.option(t.u8())
});
...
var tablesSchema = schema({
  ...
  }, notification_table_default),
  org_member_request: table({
  ...
  }, org_member_request_table_default),
  organization: table({
    name: "organization",
    indexes: [
  ...
  }, organization_table_default),
  organization_member: table({
    name: "organization_member",
    indexes: [],
    constraints: []
  }, organization_member_table_default),
  story_post: table({
    name: "story_post",
    indexes: [
  ...
  }, user_profile_table_default),
  my_feed: table({
    name: "my_feed",
    indexes: [],
    constraints: []
  }, my_feed_table_default)
});
var reducersSchema = reducers(
  reducerSchema("accept_friend_request", accept_friend_request_reducer_default),
  reducerSchema("accept_org_member", accept_org_member_reducer_default),
  reducerSchema("admin_delete_profile", admin_delete_profile_reducer_default),
  reducerSchema("admin_set_birthday", admin_set_birthday_reducer_default),
  reducerSchema("admin_set_pro", admin_set_pro_reducer_default),
  reducerSchema("admin_update_profile", admin_update_profile_reducer_default),
  reducerSchema("cancel_friend_request", cancel_friend_request_reducer_default),
  reducerSchema("claim_profile", claim_profile_reducer_default),
  reducerSchema("create_organization", create_organization_reducer_default),
  reducerSchema("create_profile", create_profile_reducer_default),
  reducerSchema("create_story_post", create_story_post_reducer_default),
  reducerSchema("decline_friend_request", decline_friend_request_reducer_default),
  reducerSchema("decline_org_member", decline_org_member_reducer_default),
  reducerSchema("delete_story_post", delete_story_post_reducer_default),
  reducerSchema("demote_co_leader", demote_co_leader_reducer_default),
  reducerSchema("follow", follow_reducer_default),
  reducerSchema("jitter_org_to_approx", jitter_org_to_approx_reducer_default),
  reducerSchema("jitter_to_approx", jitter_to_approx_reducer_default),
  reducerSchema("manual_create_profile", manual_create_profile_reducer_default),
  reducerSchema("promote_to_co_leader", promote_to_co_leader_reducer_default),
  reducerSchema("refresh_feed", refresh_feed_reducer_default),
  reducerSchema("register_push_subscription", register_push_subscription_reducer_default),
  reducerSchema("remove_org_member", remove_org_member_reducer_default),
  reducerSchema("resolve_notification", resolve_notification_reducer_default),
  reducerSchema("send_direct_message", send_direct_message_reducer_default),
  reducerSchema("send_friend_request", send_friend_request_reducer_default),
  reducerSchema("send_org_member_request", send_org_member_request_reducer_default),
  reducerSchema("send_org_message", send_org_message_reducer_default),
  reducerSchema("transfer_leadership", transfer_leadership_reducer_default),
  reducerSchema("unfollow", unfollow_reducer_default),
  reducerSchema("unfriend", unfriend_reducer_default),
  reducerSchema("unregister_push_subscription", unregister_push_subscription_reducer_default),
  reducerSchema("update_feed_scroll_position", update_feed_scroll_position_reducer_default),
  reducerSchema("update_location", update_location_reducer_default),
  reducerSchema("update_org_location", update_org_location_reducer_default),
  reducerSchema("update_organization", update_organization_reducer_default),
  reducerSchema("update_profile", update_profile_reducer_default),
  reducerSchema("upgrade_to_pro", upgrade_to_pro_reducer_default)
);
var proceduresSchema = procedures(
  procedureSchema("check_didit_verification", params, returnType),
  procedureSchema("create_verified_profile", params2, returnType2),
  procedureSchema("initiate_didit_verification", params3, returnType3)
);
var REMOTE_MODULE = {
  versionInfo: {
    cliVersion: "2.6.0"
...
// scripts_private/probe_token.mjs
var uri = "wss://maincloud.spacetimedb.com";
var db = "repsoc";
var token = process.argv[2];
if (!token) {
  console.error("usage: node probe_token.mjs <token>");
  process.exit(1);
}
try {
  const conn = await DbConnection.builder().withUri(uri).withDatabaseName(db).withToken(token).onConnect((c, id) => console.log("CONNECTED identity:", id.toHexString())).onDisconnect(() => console.log("DISCONNECTED")).onConnectError((_c, err) => console.error("CONNECT_ERROR:", err)).build();
